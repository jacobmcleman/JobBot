...
namespace JobBot
{
    ...
    constexpr unsigned char JOB_FLAG_MASK_IN_PROGRESS = 0b10000000;
...
#pragma pack(push, 1)
...
#ifdef _DEBUG
		//Need access to private function to reset UnfinishedJobCount for testing purposes.
	...
	private:
		...
		//Number of child jobs including this one that need to be completed before this job is done
		...
		*/
		...
		//2^16 is the maximum amount used in stress testing, but can easily be increased
