	...
	public:
        ...
        */
        struct Specialization
        {
            ...
            //Takes blocking/IO jobs so other workers don't have to. Will take other jobs after all IO is finished
            static Specialization IO;
            //Prefer completing graphics jobs, will only take small jobs so as to always be ready for more graphics
		...
		*/
        ...
        /*
            ...
            condition - the atomic condition variable that should be waited for, make sure that
